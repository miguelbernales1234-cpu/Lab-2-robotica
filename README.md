...
El tiempo de muestreo del controlador ($T_s$) se vinculó directamente al paso básico de simulación del entorno mediante la función `robot.getBasicTimeStep()`, fijándose en **32 ms** (o 0.032 segundos), lo que equivale a una frecuencia de muestreo de **31.25 Hz**. Esto garantiza la captura síncrona de datos del hardware en cada iteración del reloj físico de Webots.
